class LeadsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @lead.save
        format.html { redirect_to profile_leads_url(@profile), notice: 'Lead was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @lead.update(lead_params)
        ...
        format.html { redirect_to profile_leads_url(@profile), notice: 'Lead was successfully updated.' }  
  ...
  def destroy
    ...
    respond_to do |format|
      #format.html { redirect_to leads_url, notice: 'Lead was successfully destroyed.' }
        format.html { redirect_to profile_leads_url(@profile), notice: 'Lead was successfully destroyed.' }    
